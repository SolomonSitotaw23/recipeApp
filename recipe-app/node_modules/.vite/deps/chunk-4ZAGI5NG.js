...
var LocalState = function() {
  function LocalState2(_a4) {
    var cache = _a4.cache, client = _a4.client, resolvers = _a4.resolvers, fragmentMatcher = _a4.fragmentMatcher;
    this.cache = cache;
    if (client) {
      this.client = client;
    }
  ...
  LocalState2.prototype.resolveDocument = function(document, rootValue, context, variables, fragmentMatcher, onlyRunForcedResolvers) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      var mainDefinition, fragments, fragmentMap, definitionOperation, defaultOperationType, _a4, cache, client, execContext;
      return __generator(this, function(_b) {
        ...
        _a4 = this, cache = _a4.cache, client = _a4.client;
        execContext = {
          fragmentMap,
...
var ApolloClient = function() {
  function ApolloClient2(options) {
    ...
    var uri = options.uri, credentials = options.credentials, headers = options.headers, cache = options.cache, _a4 = options.ssrMode, ssrMode = _a4 === void 0 ? false : _a4, _b = options.ssrForceFetchDelay, ssrForceFetchDelay = _b === void 0 ? 0 : _b, _c = options.connectToDevTools, connectToDevTools = _c === void 0 ? typeof window === "object" && !window.__APOLLO_CLIENT__ && __DEV__ : _c, _d = options.queryDeduplication, queryDeduplication = _d === void 0 ? true : _d, defaultOptions2 = options.defaultOptions, _e = options.assumeImmutableResults, assumeImmutableResults = _e === void 0 ? false : _e, resolvers = options.resolvers, typeDefs = options.typeDefs, fragmentMatcher = options.fragmentMatcher, clientAwarenessName = options.name, clientAwarenessVersion = options.version;
...
//# sourceMappingURL=chunk-4ZAGI5NG.js.map

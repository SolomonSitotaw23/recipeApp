...
export declare type MarkRequired<T, RK extends keyof T> = Omit<T, RK> & Required<Pick<T, RK>>;
...
export declare type MarkReadonly<T, K extends keyof T> = Omit<T, K> & Readonly<Pick<T, K>>;
/** Mark some properties as writable, leaving others unchanged */
export declare type MarkWritable<T, K extends keyof T> = Omit<T, K> & Writable<Pick<T, K>>;
